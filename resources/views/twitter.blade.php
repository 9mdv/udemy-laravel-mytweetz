    ...
    <nav class="navbar navbar-default">
        <div class="container">
            <div class="navbar-header">
                <a href="/" class="navbar-brand">Tweettrrr</a>
            </div>
        </div>
    </nav>

    <div class="container">
        <form action="{{route('post.tweet')}}" method="post" class="well" enctype="multipart/form-data">
            {{csrf_field()}}
            @if(count($errors) > 0)
            ...
            <div class="form-group">
                ...
                <input type="file" name="images[]" multiple class="form-control" style="height: auto;">
            </div>
            <div class="form-group">
